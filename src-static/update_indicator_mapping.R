...
df <- dplyr$tribble(
  ...
  "idmc_displacement_conflict", "Internal displacement, conflict", NA_character_, "HDX Signals - IDMC Conflict", "Internal displacement, conflict", "Displacement, conflict", 25093,
  "idmc_displacement_disaster", "Internal displacement, disaster", NA_character_, "HDX Signals - IDMC Disaster", "Internal displacement, disaster","Displacement, disaster", 25097,
