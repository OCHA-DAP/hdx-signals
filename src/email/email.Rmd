...
flag_method <- case_when(
  ...
  flag_type == "food_security" ~ "estimated increase in populations of phase 3 and/or above from Integrated Food Security Phase Classification / Cadre Harmonisé (IPC/CH) data",
  flag_type == "cholera" ~ "increases in cholera cases from the WHO's AFRO bulletins"
)

# CERF dashboard link
cerf_link <- case_when(
  flag_type %in% c("displacement", "food_security") ~ "[CERF global monitoring dashboard](https://app.powerbi.com/groups/2ecadc97-779b-45da-bc5a-f8917fbdc734/reports/a06761fe-5edb-43f4-9d28-b01c8d813a02/ReportSection?experience=power-bi)",
