...
intro <- paste(
  ...
  "[GPT-5 large language model](https://openai.com/index/introducing-gpt-5/)",
  ...
  "secondary sources is aggregated and passed to GPT-5 to produce key",
  ...
  "Below you can find the prompts passed to GPT-5 to generate the summary text.",
  collapse = "\n"
)
